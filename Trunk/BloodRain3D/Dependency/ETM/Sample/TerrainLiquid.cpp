...
void TerrainLiquid::createTerrainLiquid( const Ogre::Vector3& seedPos, float fTextureScale, bool bDepthEnable, float fDepthScale, const ET::TerrainInfo& terrainInfo )
{
	// init parameter
	mSeedPos = seedPos;
...
{	
	...
	if( m_bDepthEnable )		texElem1 = decl->findElementBySemantic( VES_TEXTURE_COORDINATES, 1 );	// depth texture
