...
bool PickEntity(Ogre::RaySceneQuery* mRaySceneQuery, Ogre::Ray &ray, Ogre::Entity **result,Ogre::Vector3 &hitpoint, Ogre::uint32 mask , bool excludeInVisible,const Ogre::String& excludeobject, Ogre::Real max_distance)
{
