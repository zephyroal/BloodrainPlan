...
protected:
    // 递归查找行走路径。
    BOOL FindPath(fVector2 fvStart,                                              // 当前查找的开始点
    ...
    // 查找所有区域得到最近的点
    BOOL GetMinCrossPos(fVector2 fvStart,                                       // 直线的开始的点。
    ...
    // 查找两个直线的交点， 并求交点。
    BOOL CheckLineCross(fVector2 fv1Start,                                                      // 直线1的开始点。
...
public:
    ...
    BOOL    CheckCross(fVector2       fvStart,  // 直线的开始点。
