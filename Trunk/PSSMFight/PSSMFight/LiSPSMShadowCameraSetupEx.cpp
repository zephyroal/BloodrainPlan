...
namespace Ogre
{
	...
	void	LiSPSMShadowCameraSetupEx::getShadowCamera( const SceneManager *sm, const Camera *cam, const Viewport *vp, const Light *light, Camera *texCam, size_t iteration ) const
	{
