...
private:
	...
	{
		// create main model
		mBodyNode0 = sceneMgr->getRootSceneNode()->createChildSceneNode(Vector3::UNIT_Y * CHAR_HEIGHT);
		mBodyEnt0 = sceneMgr->createEntity("SinbadBody2", "Sinbad.mesh");
		mBodyNode0->attachObject(mBodyEnt0);
	...
	SceneNode* mBodyNode, *mBodyNode0;
	SceneNode* mCameraPivot;
	SceneNode* mCameraGoal;
	SceneNode* mCameraNode;
	Real mPivotPitch;
	Entity* mBodyEnt, *mBodyEnt0;
	Entity* mSword1;
	Entity* mSword2;
