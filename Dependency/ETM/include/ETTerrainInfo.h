...
// 拼接地形纹理有SPLICE_ROW*SPLICE_COL块。 最多0~31，现在将其扩展为 12*6 0~71
const unsigned int SPLICE_ROW = 12;        // 行
const unsigned int SPLICE_COL = 6;        // 列
...
public:
    ...
    void LoadTerrain(const std::string& sceneDir, const std::string& terrainFileName);
