...
public:
     ...
     */
    inline const std::string& getTextureName(const TexturesID& Id) const
    {
...
private:
     ...
     */
    bool _createTexture(Ogre::TexturePtr& Texture, const std::string& Name, const Size& Size);

    /** Get an Ogre::TexturePtr
        @param Name Texture's name
            @return Our texture
     */
    Ogre::TexturePtr _getTexture(const std::string& Name);
