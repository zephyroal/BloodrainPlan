...
public:
                   ...
                   decrease the detail level when the pixel is far to the camera.
                       ...
                       /** Save config
                           @param Data std::string reference
                        */
                       void saveCfg(std::string& Data);
...
private:
                        ...
                        */
                       const float _getPhillipsSpectrum(const Ogre::Vector2& waveVector, const Ogre::Vector2& wind, const float& kwPower_ =
                                                            2.0f) const;
