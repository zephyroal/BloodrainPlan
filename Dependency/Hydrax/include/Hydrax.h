...
public:
    ...
    */
     ...
     */
    inline const bool saveCfg(const std::string& File, const std::string& Path = "") const
    {
     ...
     */
    inline const bool loadCfg(const std::string& File) const
    {
...
public:
         ...
         */
        void eventOccurred(const std::string& eventName, const Ogre::NameValuePairList* parameters);
    };
