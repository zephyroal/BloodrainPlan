 ...
 */
    ...
    /** Set gpu program Ogre::Real parameter
        @param GpuP Gpu program type (Vertex/Fragment)
            ...
            @param Value value
     */
    void setGpuProgramParameter(const GpuProgram& GpuP, const MaterialType& MType, const std::string& Name, const Ogre::Real& Value);
    ...
    /** Set gpu program Ogre::Vector2 parameter
        @param GpuP Gpu program type (Vertex/Fragment)
            ...
            @param Value value
     */
    void setGpuProgramParameter(const GpuProgram& GpuP, const MaterialType& MType, const std::string& Name, const Ogre::Vector2& Value);
    ...
    /** Set gpu program Ogre::Vector3 parameter
        @param GpuP Gpu program type (Vertex/Fragment)
            ...
            @param Value value
     */
    void setGpuProgramParameter(const GpuProgram& GpuP, const MaterialType& MType, const std::string& Name, const Ogre::Vector3& Value);
...
private:
     ...
     */
    bool _createDepthTextureGPUPrograms(const HydraxComponent& Components, const Options& Options, const std::string& AlphaChannel);
