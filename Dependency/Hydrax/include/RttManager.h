 ...
 */
     ...
     */
    inline const std::string& getRttName(RttType Rtt) const
    {
...
public:
             ...
             */
            void renderQueueStarted(Ogre::uint8 queueGroupId, const std::string& invocation, bool& skipThisInvocation);

            /** Called on the end of the queue
             */
            void renderQueueEnded(Ogre::uint8 queueGroupId, const std::string& invocation, bool& skipThisInvocation);
...
public:
    ...
    /** Initialize the Rtt
        @param Rtt Rtt type
            ...
            @param MaterialScheme std::string("") for none
