...
const bool CfgFileManager::load(const std::string& File) const
{
...
const bool CfgFileManager::save(const std::string& File, const std::string& Path) const
{
    std::string Data =
        "#Hydrax cfg file.\n\n";
...
const bool CfgFileManager::_saveToFile(const std::string& Data, const std::string& File, const std::string& Path) const
{
...
const void CfgFileManager::_loadCfgFile(const std::string& File, std::pair<bool, Ogre::ConfigFile>& Result) const
{
...
std::string CfgFileManager::_getCfgString(const std::string& Name, const int& Value)
{
    return "<int>" + Name + "=" + Ogre::StringConverter::toString(Value) + "\n";
}

std::string CfgFileManager::_getCfgString(const std::string& Name, const Ogre::Real& Value)
{
    return "<float>" + Name + "=" + Ogre::StringConverter::toString(Value) + "\n";
}

std::string CfgFileManager::_getCfgString(const std::string& Name, const bool& Value)
{
    return "<bool>" + Name + "=" + Ogre::StringConverter::toString(Value) + "\n";
}

std::string CfgFileManager::_getCfgString(const std::string& Name, const Ogre::Vector2& Value)
{
    return "<vector2>" + Name + "=" + Ogre::StringConverter::toString(Value.x) + "x" + Ogre::StringConverter::toString(Value.y) + "\n";
}

std::string CfgFileManager::_getCfgString(const std::string& Name, const Ogre::Vector3& Value)
{
    return "<vector3>" + Name + "=" + Ogre::StringConverter::toString(Value.x) + "x" + Ogre::StringConverter::toString(Value.y) + "x" +
           Ogre::StringConverter::toString(Value.z) + "\n";
}

std::string CfgFileManager::_getCfgString(const std::string& Name, const Size& Value)
{
    return "<size>" + Name + "=" + Ogre::StringConverter::toString(Value.Width) + "x" + Ogre::StringConverter::toString(Value.Height) + "\n";
}

const std::string CfgFileManager::_getComponentsCfgString() const
{
    std::string                  Cmpnts = "Components=";

    std::pair<bool, std::string> Cmp[8] = {
        std::pair<bool, std::string>(mHydrax->isComponent(HYDRAX_COMPONENT_SUN),                    "Sun"),
        std::pair<bool, std::string>(mHydrax->isComponent(HYDRAX_COMPONENT_FOAM),                   "Foam"),
        std::pair<bool, std::string>(mHydrax->isComponent(HYDRAX_COMPONENT_DEPTH),                  "Depth"),
        std::pair<bool, std::string>(mHydrax->isComponent(HYDRAX_COMPONENT_SMOOTH),                 "Smooth"),
        std::pair<bool, std::string>(mHydrax->isComponent(HYDRAX_COMPONENT_CAUSTICS),               "Caustics"),
        std::pair<bool, std::string>(mHydrax->isComponent(HYDRAX_COMPONENT_UNDERWATER),             "Underwater"),
        std::pair<bool, std::string>(mHydrax->isComponent(HYDRAX_COMPONENT_UNDERWATER_REFLECTIONS), "UnderwaterReflections"),
        std::pair<bool, std::string>(mHydrax->isComponent(HYDRAX_COMPONENT_UNDERWATER_GODRAYS),     "UnderwaterGodRays"),
    };
...
bool CfgFileManager::_isStringInList(const Ogre::StringVector& List, const std::string& Find)
{
...
const std::string CfgFileManager::_getRttCfgString() const
{
    return
...
const std::string CfgFileManager::_getVersionCfgString() const
{
...
int CfgFileManager::_getIntValue(Ogre::ConfigFile& CfgFile, const std::string Name)
{
    std::string Value = CfgFile.getSetting("<int>" + Name);
...
Ogre::Real CfgFileManager::_getFloatValue(Ogre::ConfigFile& CfgFile, const std::string Name)
{
    std::string Value = CfgFile.getSetting("<float>" + Name);
...
bool CfgFileManager::_getBoolValue(Ogre::ConfigFile& CfgFile, const std::string Name)
{
    std::string Value = CfgFile.getSetting("<bool>" + Name);
...
Ogre::Vector2 CfgFileManager::_getVector2Value(Ogre::ConfigFile& CfgFile, const std::string Name)
{
    std::string Value = CfgFile.getSetting("<vector2>" + Name);
...
Ogre::Vector3 CfgFileManager::_getVector3Value(Ogre::ConfigFile& CfgFile, const std::string Name)
{
    std::string Value = CfgFile.getSetting("<vector3>" + Name);
...
Size CfgFileManager::_getSizeValue(Ogre::ConfigFile& CfgFile, const std::string Name)
{
    std::string Value = CfgFile.getSetting("<size>" + Name);
