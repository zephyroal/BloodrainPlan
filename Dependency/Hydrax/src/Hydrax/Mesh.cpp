...
void Mesh::setOptions(const Options& Options)
{
    if (mCreated)
    {
        ...
        {
            mSceneNode->setPosition(mHydrax->getPosition().x - Options.MeshSize.Width / 2, mHydrax->getPosition().y,
                                    mHydrax->getPosition().z - Options.MeshSize.Height / 2);
        }
    }
...
void Mesh::create()
{
    ...
    mSceneNode->setPosition(mHydrax->getPosition().x - mOptions.MeshSize.Width / 2, mHydrax->getPosition().y,
                            mHydrax->getPosition().z - mOptions.MeshSize.Height / 2);
