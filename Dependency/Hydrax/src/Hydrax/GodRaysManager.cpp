...
void GodRaysManager::_updateProjector()
{
    ...
    Ogre::Vector3        WaterPosition        =
        Ogre::Vector3(WaterProjectionPoint.x, mHydrax->getHeigth(WaterProjectionPoint), WaterProjectionPoint.z);
