...
void Hydrax::DeviceListener::eventOccurred(const std::string& eventName, const Ogre::NameValuePairList* parameters)
{
    // If needed...
...
void Hydrax::setModule(Module::Module* Module, const bool& DeleteOldModule)
{
    ...
    if (mCreated)
    {
        ...
        std::string MaterialNameTmp = mMesh->getMaterialName();
